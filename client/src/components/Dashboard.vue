<template>
  <div>
    <NavBar/>
    <div class="container">
      <router-link class="btn btn-primary pull-right" to="/new-doc">Create Doc</router-link>
      <div class="container">
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-block">
                ...
                <p class="card-link">Created by: {{document.owner}}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div v-if="searchResults.length > 0">
        <div class="row" v-for="document in searchResults">
          <div class="col-sm-6">
            <div class="card">
              <div class="card-block">
